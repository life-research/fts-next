...
class TransferProcessControllerTest {
  ...
  void startExistingProjectSucceeds() {
    ...
    transportIdMap.addParameter("transport-id-map-name", "mapName");
  ...
  void minimalTransportBundleConversionSucceeds() {
    Bundle bundle =
        Stream.of(
                new Parameters()
                    .addParameter("transport-id-map-name", new StringType("mapName"))
                    .setId("transport-id-map"))
            .collect(toBundle());

    TransportBundle transportBundle = fromPlainBundle(bundle);
    assertThat(transportBundle.mapName()).isEqualTo("mapName");
  ...
  void unknownTransportBundleConversionParamErrors() {
    Bundle bundle =
        Stream.of(
                new Parameters()
                    .addParameter("unknown", new StringType("mapName"))
                    .setId("transport-id-map"))
            .collect(toBundle());
